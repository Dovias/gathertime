...
public class ChatService {
  ...
  public CommentDTO createComment(
    ...
    final Chat chat = this.chatRepository.findById(chatId).orElseThrow(() ->
  ...
  public List<CommentDTO> getChatComments(final Long chatId) {
    ...
    final List<Comment> comments = this.commentRepository.findChatComments(
      chat.getId(),
      PageRequest.of(0, 20)
    );
  ...
  public void updateComment(
    ...
    final Comment comment = this.commentRepository.findById(
      commentId
    ).orElseThrow(() ->
